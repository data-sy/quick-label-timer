...
// MARK: - V24: Subtle Background + Border
struct TimerRowRunningV24: View {
    let timer: TimerData
    ...
    var body: some View {
        ...
        .padding()
        .background(isRunning ? Color.blue.opacity(0.08) : AppTheme.contentBackground)
        .cornerRadius(20)
        .overlay(
            RoundedRectangle(cornerRadius: 20)
                .stroke(isRunning ? Color.blue.opacity(0.6) : Color.clear, lineWidth: 2)
        )
